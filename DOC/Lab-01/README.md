...
![Priority Queue System diagram](./images/archi.drawio.svg)

### 2. Client Interaction Flow
![Process Dataflow Sequence diagram](./images/Dataflow.drawio.svg)
...
![Priority Queue System diagram](./images/priorityqueue.drawio.svg)
...
![Priority Queue System diagram](./images/taskflow.svg)
...
![Priority Queue System diagram](./images/task_worker.drawio.svg)
...
### 6. Monitoring System
![Priority Queue System diagram](./images/workerTask.drawio.svg)
...
![Priority Queue System diagram](./images/taskflow.drawio.svg)
...
![Load Balancer Setup](./images/poridhilab.png)
...
![Load Balancer Configuration](./images/poridhilab2.png)
...
![Load Balancer Details](./images/poridhilab3.png)

![Load Balancer Final Setup](./images/poridhilab4.png)
...
```
You can see:
![alt text](./images/poridhilab5.png)
**Headers:**
```
...
```
You can see:
![alt text](./images/poridhilab6.png)
### Task Types
...
![alt text](./images/poridhilab7.png)
...
![alt text](./images/poridhilab8.png)
